...
def temporal_difference(values, alpha=0.1, batch=False):
    """
    values: Estimated values of 7 states
    :return: List of states visited, list of updated values of states
    """
    state = 3
    trajectory = [state]
    rewards = [0]
    while True:  # Until you reach terminal state
        old_state = state
